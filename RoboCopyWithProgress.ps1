function Copy-WithProgress {
    ...
    $StagingLogPath = '{0}\temp\{1} robocopy staging.log' -f 'D:', (Get-Date -Format 'yyyy-MM-dd hh-mm-ss');
    ...
    $RobocopyLogPath = '{0}\temp\{1} robocopy_fcs_to_67a.log' -f 'D:', (Get-Date -Format 'yyyy-MM-dd hh-mm-ss');
...
Copy-WithProgress -Source 'E:\plm\dev2' -Destination '\\v0667a\15x_Dev2' -Verbose;